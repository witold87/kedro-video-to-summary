...
# vid_to_summary_kedro documentation build
...
from vid_to_summary_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "vid_to_summary_kedro"
author = "Kedro"
...
htmlhelp_basename = "vid_to_summary_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "vid_to_summary_kedro.tex",
        "vid_to_summary_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "vid_to_summary_kedro",
        "Project vid_to_summary_kedro codebase.",
        "Data-Science",
    )
]
